...
export default function CropPredictionPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-10">
      ...
      // ...
      <h1 className="text-3xl font-bold mb-8 text-center flex items-center justify-center gap-2"><FaSeedling className="text-yellow-600" /> CROP YIELD AI RECOMMENDATION</h1>
// ...
      <h2 className="text-xl font-semibold mb-3 flex items-center gap-2"><FaFlask className="text-blue-500" /> Soil Health Data</h2>
// ...
      <h2 className="text-xl font-bold mb-3 flex items-center gap-2"><FaLeaf className="text-green-600" /> Prediction Result</h2>
