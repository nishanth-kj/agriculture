...
/**
 * Standardized API Error Codes and their default values
 * Codes are now numeric for better database and client integration.
 */
export const ApiErrorCode: EnumDefinition<
    "VALIDATION_ERROR" |
